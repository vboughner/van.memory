...
describe('default tests', () => {
  ...
  const EXPECTED_SPEECH = 'There are no memories, please ask me to remember something first.'
  const EXPECTED_DISPLAY = 'There are no memories, please ask me to remember something first.'
