...
describe('default tests', () => {
  ...
  const EXPECTED_DIALOG_MODE = 'ResultCommentary'
  const EXPECTED_SPEECH = 'You told me a few seconds ago, my mother\'s birthday is January 22nd'
  const EXPECTED_DISPLAY = 'Here’s the best match.'
