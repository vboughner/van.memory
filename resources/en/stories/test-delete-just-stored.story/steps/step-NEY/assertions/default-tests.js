...
describe('default tests', () => {
  const EXPECTED_TYPE_NAME = 'DeleteJustMemorizedAction'
  const EXPECTED_DIALOG_MODE = 'Confirmation'
  const EXPECTED_SPEECH = 'You just asked me to remember that. Are you sure you want to delete it?'
  const EXPECTED_DISPLAY = 'You just asked me to remember that. Are you sure you want to delete it?'
