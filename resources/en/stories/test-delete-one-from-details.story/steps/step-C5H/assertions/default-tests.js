...
describe('default tests', () => {
  const EXPECTED_TYPE_NAME = 'ListResponse'
  const EXPECTED_DIALOG_MODE = 'Result'
  const EXPECTED_SPEECH = 'You have 1 memory. This memory is: I need this memory only a little while. '
  const EXPECTED_DISPLAY = 'You have 1 memory. '
