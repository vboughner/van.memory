...
describe('default tests', () => {
  const EXPECTED_TYPE_NAME = 'RecallResponse'
  const EXPECTED_DIALOG_MODE = 'Result'
  const EXPECTED_SPEECH = 'I can’t find a memory that matches a search for "supercalifragalistic". Please try another question.'
  const EXPECTED_DISPLAY = 'I can’t find a memory that matches a search for "supercalifragalistic". Please try another question.'
