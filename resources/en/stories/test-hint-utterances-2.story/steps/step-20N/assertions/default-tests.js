...
describe('default tests', () => {
  const EXPECTED_TYPE_NAME = 'MemorizeResponse'
  const EXPECTED_DIALOG_MODE = 'Result'
  const EXPECTED_SPEECH = 'I will remember that you said: the cookies are in the back of the 2nd shelf on the right.'
  const EXPECTED_DISPLAY = 'I’ll remember what you said.'
