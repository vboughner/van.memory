...
describe('default tests', () => {
  const EXPECTED_TYPE_NAME = 'DeleteLastMemoryAction'
  const EXPECTED_DIALOG_MODE = 'Confirmation'
  const EXPECTED_SPEECH = 'Are you sure you want to delete the most recently stored memory?'
  const EXPECTED_DISPLAY = 'Are you sure you want to delete the most recently stored memory?'
