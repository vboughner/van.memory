...
describe('default tests', () => {
  const EXPECTED_TYPE_NAME = 'RecallLastMemoryResponse'
  const EXPECTED_DIALOG_MODE = 'Result'
  const EXPECTED_SPEECH = 'You stored the most recent memory a few seconds ago. You told me: I stored this memory just a moment ago.'
  const EXPECTED_DISPLAY = 'Here’s the most recent memory.'
