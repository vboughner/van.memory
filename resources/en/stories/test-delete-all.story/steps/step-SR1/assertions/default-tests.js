...
describe('default tests', () => {
  const EXPECTED_TYPE_NAME = 'DeleteAllAction'
  const EXPECTED_DIALOG_MODE = 'Confirmation'
  const EXPECTED_SPEECH = 'Are you sure you want to delete all memories?'
  const EXPECTED_DISPLAY = 'Are you sure you want to delete all memories?'
