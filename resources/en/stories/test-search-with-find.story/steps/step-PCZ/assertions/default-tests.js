...
describe('default tests', () => {
  ...
  const EXPECTED_SPEECH = 'I can’t find a memory that matches a search for "my parking space". Please try another question.'
  const EXPECTED_DISPLAY = 'I can’t find a memory that matches a search for "my parking space". Please try another question.'
