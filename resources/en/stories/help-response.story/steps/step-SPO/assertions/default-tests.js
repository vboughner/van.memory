...
describe('default tests', () => {
  const EXPECTED_TYPE_NAME = 'HelpResponse'
  const EXPECTED_DIALOG_MODE = 'Result'
  const EXPECTED_SPEECH = 'Tell me to remember something, and I’ll remember it. Ask me a question that includes a few words from that memory, and I’ll find it for you.'
  const EXPECTED_DISPLAY = 'Tell me to remember something, and I’ll remember it. Ask me a question that includes a few words from that memory, and I’ll find it for you.'
