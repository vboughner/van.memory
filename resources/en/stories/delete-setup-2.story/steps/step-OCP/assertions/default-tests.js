...
describe('default tests', () => {
  const EXPECTED_TYPE_NAME = 'DeleteSomeAction'
  const EXPECTED_DIALOG_MODE = 'Confirmation'
  const EXPECTED_SPEECH = 'Are you sure you want to delete everything that matched?'
  const EXPECTED_DISPLAY = 'Are you sure you want to delete everything that matched?'
