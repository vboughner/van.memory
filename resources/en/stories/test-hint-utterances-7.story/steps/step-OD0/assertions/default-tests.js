...
describe('default tests', () => {
  ...
  const EXPECTED_SPEECH = 'You told me a few seconds ago: I need to buy celery. Here are all memories that sound similar:'
  const EXPECTED_DISPLAY = 'Here are similar memories.'
