...
describe('default tests', () => {
  const EXPECTED_TYPE_NAME = 'RecallInputConcept'
  const EXPECTED_DIALOG_MODE = 'Elicitation'
  const EXPECTED_SPEECH = 'What would you like me to recall for you?'
  const EXPECTED_DISPLAY = 'What would you like me to recall for you?'
