...
describe('default tests', () => {
  ...
  const EXPECTED_SPEECH = 'You told me a few seconds ago, ladybugs can fly. Would you like to hear the next matching memory? '
  const EXPECTED_DISPLAY = 'Would you like to hear the next matching memory? '
